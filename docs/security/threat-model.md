...
| RISK-ASSESS-06     | A release cannot be undone; a result disclosed early stays disclosed                                              | Low                             | Accepted; un-releasing a mark a child has already read achieves nothing    |
| RISK-ASSESS-07     | Nothing records who READ a released result or a marked paper; only the release itself is audited                  | Medium                          | Open; the same gap as RISK-ASSESS-03, widened by the review endpoint       |
| RISK-ASSESS-08     | A teacher of the class may release any of that class's results, including for an assessment they did not author   | Low                             | Accepted; class standing is the platform's unit of teaching authority      |
